#
#  Be sure to run `pod spec lint DFTimelineView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Fast-Dev-Kit"
  # s.authors            = { "Fast-Dev-Kit" => "2642754767@qq.com" }
  # s.social_media_url   = "http://twitter.com/Fast-Dev-Kit"
  ...
  # s.dependency 'DFCommon', :git => 'https://github.com/anyunzhong/DFCommon.git', :tag => '1.1.0'
